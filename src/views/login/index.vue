<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" label-position="left" label-width="0px" class="login-form">
      <h3 class="title">慧来学智能系统 后台管理系统</h3>
...
<style rel="stylesheet/scss" lang="scss">
  .login {
    ...
    background: linear-gradient(#2a6aa8,#9198e5);
    -moz-background: linear-gradient(#2a6aa8,#9198e5);
    -webkit-background: linear-gradient(#2a6aa8,#9198e5);
  }
  .title {
