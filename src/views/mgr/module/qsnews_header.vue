<template>
  <div class="head-container">
    ...
    <el-input v-model="query.synopsis" clearable placeholder="作者或编者" style="width: 200px;" class="filter-item" @keyup.enter.native="toQuery"/>

    <el-button class="filter-item" size="mini" type="success" icon="el-icon-search" @click="toQuery">搜索</el-button>
    <!-- 新增 -->
    <div style="display: inline-block;margin: 0px 2px;">
      <el-button
        v-permission="['ADMIN','QSNEWS_ALL','QSNEWS_CREATE']"
        class="filter-item"
        size="mini"
        type="primary"
        icon="el-icon-plus"
  ...
  data() {
    return {
      queryTypeOptions: [
        ...
        { key: 'synopsis', display_name: '内容简介' }
      ]
    }
  },
  methods: {
