<template>
  <div>
    <el-button size="mini" type="primary" @click="to">关联教材</el-button>
    <eForm ref="form" :sup_this="sup_this" :is-add="false" :dicts="dicts"/>
  </div>
</template>
<script>
import eForm from './qsdept_formQs'
import { transferInfoQs } from '@/api/qsTextbookAuth'
...
export default {
  ...
  methods: {
    to() {
      ...
      transferInfoQs(params).then(res => {
