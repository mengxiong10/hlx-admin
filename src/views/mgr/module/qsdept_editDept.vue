<template>
  <div>
    <el-button size="mini" type="primary" @click="to">关联部门</el-button>
    <eForm ref="form" :sup_this="sup_this" :is-add="false" :dicts="dicts"/>
  </div>
</template>
<script>
import eForm from './qsdept_formDept'
import { transferInfoDept } from '@/api/qsRechargeAuth'
...
export default {
  ...
  methods: {
    to() {
      ...
      transferInfoDept(params).then(res => {
