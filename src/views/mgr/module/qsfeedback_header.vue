<template>
  <div class="head-container">
    ...
    <!--
      ...
      -->
    <el-select v-model="query.enabled" clearable placeholder="回复状态" style="width: 200px;" class="filter-item">
      <el-option key="null" value label="全部" />
      <el-option key="0" value="0" label="未回复" />
      <el-option key="1" value="1" label="已回复" />
    </el-select>
    <el-input v-model="query.recontent" clearable placeholder="来信内容" style="width: 200px;" class="filter-item" @keyup.enter.native="toQuery"/>
    <el-input v-model="query.response" clearable placeholder="回复内容" style="width: 200px;" class="filter-item" @keyup.enter.native="toQuery"/>
