<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      <el-table-column prop="qsexamId" label="试卷"/>
      ...
      <el-table-column v-if="checkPermission(['ADMIN','QSEXAMAUTH_ALL','QSEXAMAUTH_EDIT','QSEXAMAUTH_DELETE'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <edit v-permission="['ADMIN','QSEXAMAUTH_ALL','QSEXAMAUTH_EDIT']" :data="scope.row" :sup_this="sup_this"/>
          <el-popover
...
import { del } from '@/api/qsExamAuth'
import { parseTime } from '@/utils/index'
import eHeader from './module/qsexamauth_header'
import edit from './module/qsexamauth_edit'
export default {
