<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" border style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['ADMIN','QSAUDIO_ALL','QSAUDIO_EDIT','QSAUDIO_DELETE'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <edit v-permission="['ADMIN','QSAUDIO_ALL','QSAUDIO_EDIT']" :data="scope.row" :sub-types="subTypes" :sup_this="sup_this"/>
          <el-popover
...
export default {
  ...
  methods: {
    ...
    beforeInit() {
      ...
      if (word !== '' && word !== null) { this.params['word'] = word }
      const audioType = query.audioType
      if (audioType !== '' && audioType !== null) { this.params['audioType'] = audioType }
