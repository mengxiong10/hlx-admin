<template>
  <div class="head-container">
    ...
    <el-input v-model="query.qstextbookName" clearable placeholder="课程名称" style="width: 200px;" class="filter-item" @keyup.enter.native="toQuery"/>
    <el-input v-model="query.qsTextbookTwoName" clearable placeholder="单元名称" style="width: 200px;" class="filter-item" @keyup.enter.native="toQuery"/>
    ...
    <el-input v-model="query.teachName" clearable placeholder="教师姓名" style="width: 200px;" class="filter-item" @keyup.enter.native="toQuery"/>
