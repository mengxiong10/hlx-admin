      ...
      <el-table-column type="expand" label="其他">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="学段:">
                  <span>{{ transName(grades, props.row.grade) }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="学习端:">
                  <span>{{ transName(stuauths, props.row.auth_type) }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            ...
            type="primary"
            size="mini"
            @click="toQs(scope.row.id)"
            >已学课程</el-button
          >
          <el-popover
            v-permission="['ADMIN', 'QSSTUDENT_ALL', 'QSSTUDENT_DELETE']"
            :ref="scope.row.id"
            placement="top"
            width="180"
          >
